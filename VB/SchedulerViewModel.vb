...
Namespace SchedulerBindToObservableCollectionWpf
    Public Class SchedulerViewModel
        ...
        Private currentModelAppointment_Renamed As ModelAppointment
        Public Property CurrentModelAppointment() As ModelAppointment
            Get
                Return currentModelAppointment_Renamed
            End Get
            Set(ByVal value As ModelAppointment)
                If value IsNot currentModelAppointment_Renamed Then
                    currentModelAppointment_Renamed = value
                    ScrollToAppointment()
                End If
            End Set
        End Property
